...
// import { createModel } from './speech';
import { createListeningStream } from './utils/createStream';
...
async function record(
	...
	if (connection) {
		...
		if (connection.receiver.speaking.users.has(userId)) {
			createListeningStream(receiver, userId, 'model', client.users.cache.get(userId));
		}
